...
export const eduDetails = [
  {
    Position: "Graduation in Sytem Development and Technology",
  ...
  {
    Position: "Bachelor in International Trade",
...
export const contactDetails = {
  email: "leticiamagrin@outlook.com",
